...
def test_feed_dict(model, optimizer, batch_dim):
    ...
    embeddings, z_discrete = model.sample_z_test(a.shape[0])
...
output, z_sample = trainer.test(batch_dim=batch_dim,
